...
//////////////////////////////Sistema de aceite de lubricación/////////////////////////////////////////////////////
			...
			params.put("activity", "Revisar el tubo de vidrio de flujo de aceite lubricante para verificar que este fluye");
			params.put("frequency", "1");
			params.put("level", "1");
			params.put("time", "5 minutos");
			params.put("personal", "1");
			...
			params = new HashMap<>();
			params.put("secction", "Sistema de aceite de lubricación");
			params.put("activity", "Realizar prueba de funcionamiento de bomba neumática de pre/post lubricación de aceite para verificar que no existan fugas de gas, fugas de aceite, vibraciones y ruidos extraños.");
			...
			params = new HashMap<>();
			params.put("secction", "Sistema de aceite de lubricación");
			params.put("activity", "Realizar prueba de funcionamiento de bomba de aceite lubricante auxiliar accionada por motor eléctrico para verificación adictiva de ruidos extraños, vibraciones y medición de voltaje.");
			params.put("frequency", "30");
			params.put("level", "1, 2, 3");
			params.put("time", "1/2");
			params.put("personal", "2");
			...
			params = new HashMap<>();
			params.put("secction", "Sistema de aceite de lubricación");
			params.put("activity", "Realizar prueba de funcionamiento de bomba principal  neumática de aceite sello lubricante para verificar que no existan fugas de gas, fugas de aceite, vibraciones y ruidos extraños.");
			params.put("frequency", "30");
			params.put("level", "1, 2, 3");
			params.put("time", "1/2");
			params.put("personal", "2");
...
//////////////////////////////Enfriador de aceite/////////////////////////////////////////////////////
			...
			params.put("activity", "Realizar inspección visual al enfriador de aceite para verificar que no tenga pernos sueltos y verificar si el radiador está sucio o tapado.");
			params.put("frequency", "30");
			params.put("level", "3");
			params.put("time", "1");
			params.put("personal", "2");
			...
			params = new HashMap<>();
			params.put("secction", "Enfriador de aceite");
			params.put("activity", "Quitar la tierra y polvo de la superficie de transferencia de calor cepillando los tubos y aletas y soplando la tierra suelta  con aire comprimido.");
			params.put("frequency", "30");
			params.put("level", "3");
			params.put("time", "1");
			params.put("personal", "2");
...
//////////////////////////////Consola de Control/////////////////////////////////////////////////////
			...
			params = new HashMap<>();
			params.put("secction", "Consola de Control");
			params.put("activity", "Revisar las conexiones eléctricas de la consola de control para verificar que estén bien afianzadas.");
			params.put("frequency", "14");
			params.put("level", "2");
			params.put("time", "20 minutos");
			params.put("personal", "1");
			...
			params = new HashMap<>();
			params.put("secction", "Consola de Control");
			params.put("activity", "Revisar las cajas de empalme y verificar la condición general del equipo y si hay señales de condensación.");
			params.put("frequency", "30");
			params.put("level", "3");
			params.put("time", "1");
			params.put("personal", "2");
			...
			params = new HashMap<>();
			params.put("secction", "Consola de Control");
			params.put("activity", "Revisar el sistema de fallas y protección, cerciorarse que hay continuidad (perdida de señal) en los puntos de fijación seleccionados");
			params.put("frequency", "7");
			params.put("level", "2");
			params.put("time", "1");
			params.put("personal", "2");
